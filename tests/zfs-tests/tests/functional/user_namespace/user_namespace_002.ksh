...
log_must zfs allow -u $ROOT_UID create,destroy,mount $USER_TESTFS
...
log_must zfs unallow -u $ROOT_UID create,destroy,mount $USER_TESTFS
log_must zfs destroy $USER_TESTFS

log_pass "Delegated permissions map to user namespaces"
